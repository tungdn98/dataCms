...
/**
 * Criteria class for the {@link vn.com.datamanager.domain.ActivityObject} entity. This class is used
 * in {@link vn.com.datamanager.web.rest.ActivityObjectResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /activity-objects?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class ActivityObjectCriteria implements Serializable, Criteria {
    ...
    public ActivityObjectCriteria() {}

    public ActivityObjectCriteria(ActivityObjectCriteria other) {
    ...
    @Override
    public ActivityObjectCriteria copy() {
        return new ActivityObjectCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ActivityObjectCriteria that = (ActivityObjectCriteria) o;
        return (
