...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTTYPE actions', async () => {
      const expectedActions = [
        {
