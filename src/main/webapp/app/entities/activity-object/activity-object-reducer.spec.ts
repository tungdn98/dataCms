...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITYOBJECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVITYOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVITYOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVITYOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITYOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVITYOBJECT actions', async () => {
      const expectedActions = [
        {
