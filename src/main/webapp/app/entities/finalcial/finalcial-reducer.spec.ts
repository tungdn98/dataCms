...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './finalcial.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINALCIAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_FINALCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINALCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINALCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINALCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINALCIAL actions', async () => {
      const expectedActions = [
        {
