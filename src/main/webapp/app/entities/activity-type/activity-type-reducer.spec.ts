...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITYTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
