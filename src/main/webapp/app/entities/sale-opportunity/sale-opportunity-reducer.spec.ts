...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALEOPPORTUNITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALEOPPORTUNITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALEOPPORTUNITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALEOPPORTUNITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALEOPPORTUNITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALEOPPORTUNITY actions', async () => {
      const expectedActions = [
        {
