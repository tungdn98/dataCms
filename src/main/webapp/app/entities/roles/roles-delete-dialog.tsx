...
export const RolesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dataCmsApp.roles.delete.question">Are you sure you want to delete this Roles?</ModalBody>
      <ModalFooter>
