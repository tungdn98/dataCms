...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALECONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALECONTRACT actions', async () => {
      const expectedActions = [
        {
