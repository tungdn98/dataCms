...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './opportunity-stage-reason.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPPORTUNITYSTAGEREASON_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPPORTUNITYSTAGEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPPORTUNITYSTAGEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPPORTUNITYSTAGEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPPORTUNITYSTAGEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPPORTUNITYSTAGEREASON actions', async () => {
      const expectedActions = [
        {
