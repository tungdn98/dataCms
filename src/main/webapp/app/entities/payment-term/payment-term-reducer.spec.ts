...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTTERM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYMENTTERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTTERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTTERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTTERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTTERM actions', async () => {
      const expectedActions = [
        {
