...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLEGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROLEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROLEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROLEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROLEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROLEGROUP actions', async () => {
      const expectedActions = [
        {
