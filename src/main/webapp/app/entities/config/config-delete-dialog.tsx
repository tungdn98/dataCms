...
export const ConfigDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dataCmsApp.config.delete.question">Are you sure you want to delete this Config?</ModalBody>
      <ModalFooter>
