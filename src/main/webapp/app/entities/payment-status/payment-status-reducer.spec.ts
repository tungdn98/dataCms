...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
