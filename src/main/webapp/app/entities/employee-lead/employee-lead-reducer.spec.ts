...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEELEAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEELEAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEELEAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEELEAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEELEAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEELEAD actions', async () => {
      const expectedActions = [
        {
