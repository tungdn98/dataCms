...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONFIGLOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONFIGLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONFIGLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONFIGLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONFIGLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONFIGLOG actions', async () => {
      const expectedActions = [
        {
