...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './emp-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPGROUP actions', async () => {
      const expectedActions = [
        {
