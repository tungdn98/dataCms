...
export const ActivityDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dataCmsApp.activity.delete.question">Are you sure you want to delete this Activity?</ModalBody>
      <ModalFooter>
