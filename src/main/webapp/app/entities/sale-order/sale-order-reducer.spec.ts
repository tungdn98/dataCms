...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALEORDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALEORDER actions', async () => {
      const expectedActions = [
        {
