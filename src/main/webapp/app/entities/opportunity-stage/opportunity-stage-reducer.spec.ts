...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './opportunity-stage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPPORTUNITYSTAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPPORTUNITYSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPPORTUNITYSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPPORTUNITYSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPPORTUNITYSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPPORTUNITYSTAGE actions', async () => {
      const expectedActions = [
        {
